...
INT _tmain(INT argc, LPTSTR argv[]){
	...
	PHANDLE		full  = (PHANDLE)malloc(Q   * sizeof(HANDLE)); /*+1 because the last one is used in order to termianate the thread															/*if it is released it means that the server thread has to stop*/	
